...
| 2 | Key auth at Kong | [docs-2.0/02-key-auth-2.0.md](docs-2.0/02-key-auth-2.0.md) | ✅ config verified — note: `global: true` (gates the whole control plane, unlike 1.x's scoped key-auth) · ❌ traffic untested · ⚠️ credential secret value not retrievable after creation (beta API limitation) |
